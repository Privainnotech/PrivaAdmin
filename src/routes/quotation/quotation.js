...
router.get('/subitem/:ItemId', async (req, res) => {
    try{
        ...
        getQuotationSubItem = `SELECT a.SubItemId, b.ProductCode , b.ProductName SubItemName, b.ProductPrice SubItemPrice, a.SubItemQty, a.SubItemUnit, a.SubItemQty+a.SubItemUnit SubItemQtyUnit
            FROM [QuotationSubItem] a
            LEFT JOIN [MasterProduct] b ON a.ProductId = b.ProductId
